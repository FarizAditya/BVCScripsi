...
Route::post('/ger-order-summery',[CartController::class,'getOrderSummery'])->name('front.getOrderSummery');
...
Route::group(['prefix' => 'admin'],function(){
    ...
    Route::group(['middleware' =>'admin.auth'],function(){
        ...
        Route::delete('/sub-brands/{brand}',[BrandController::class,'destroy'])->name('brands.delete');
