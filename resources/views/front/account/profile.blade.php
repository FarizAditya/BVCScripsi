                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">                  
                                    ...
                                    <input value="{{(!empty($address)) ? $address->mobile : '' }}" type="text" name="mobile" id="mobile" placeholder="Enter Your Mobile Phone" class="form-control">
                                    <p></p>
                                </div>
                                <div class="mb-3">                  
        ...
        $.ajax({
            ...
            success: function(response){
                if(response.status == true) {
                    ...
                    $("#profileForm #email").addClass('is-invalid').siblings("p").addClass('invalid-feedback');
                    $("#profileForm #phone").addClass('is-invalid').siblings("p").addClass('invalid-feedback');
