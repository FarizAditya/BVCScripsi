...
<script type="text/javascript">
    ...
    if (category_id) { // Pengecekan validitas category_id
    	$.ajax({
    		...
    		success: function(response){
                ...
                $.each(response.SubCategories, function(key, item){ // Menggunakan response.SubCategories
    	...
    	console.log("category_id tidak valid");
    }
});
